...
def create_lmdb_for_rain13k():
    folder_path = './datasets/Rain13K/train/Rain13K/input'
    lmdb_path = './datasets/Rain13K/train/Rain13K/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/Rain13K/train/Rain13K/target'
    lmdb_path = './datasets/Rain13K/train/Rain13K/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_rain13k_test(dataset_name="Rain100H"):
    folder_path = f'./datasets/Rain13K/test/{dataset_name}/input'
    lmdb_path = f'./datasets/Rain13K/test/{dataset_name}/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = f'./datasets/Rain13K/test/{dataset_name}/target'
    lmdb_path = f'./datasets/Rain13K/test/{dataset_name}/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_hide():
    folder_path = './datasets/HIDE/test/input'
    lmdb_path = './datasets/HIDE/test/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/HIDE/test/target'
    lmdb_path = './datasets/HIDE/test/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    
def create_lmdb_for_realblur(dataset_name="RealBlur_J"):
    folder_path = f'./datasets/{dataset_name}/test/input'
    lmdb_path = f'./datasets/{dataset_name}/test/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = f'./datasets/{dataset_name}/test/target'
    lmdb_path = f'./datasets/{dataset_name}/test/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_rwbi(dataset_name="RWBI"):
    folder_path = f'./datasets/{dataset_name}/test/input'
    lmdb_path = f'./datasets/{dataset_name}/test/input.lmdb'
...
def create_lmdb_for_dpdd():
    """
    folder_path = './datasets/DPDD/train/inputC_crops'
    lmdb_path = './datasets/DPDD/train/inputC_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    
    folder_path = './datasets/DPDD/train/inputL_crops'
    lmdb_path = './datasets/DPDD/train/inputL_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/DPDD/train/inputR_crops'
    lmdb_path = './datasets/DPDD/train/inputR_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/DPDD/train/target_crops'
    lmdb_path = './datasets/DPDD/train/target_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    """
    folder_path = './datasets/DPDD/val/inputC'
    lmdb_path = './datasets/DPDD/val/inputC.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    
    folder_path = './datasets/DPDD/val/inputL'
    lmdb_path = './datasets/DPDD/val/inputL.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/DPDD/val/inputR'
    lmdb_path = './datasets/DPDD/val/inputR.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/DPDD/val/target'
    lmdb_path = './datasets/DPDD/val/target.lmdb'
