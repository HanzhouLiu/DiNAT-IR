...
class DeblurDiNAT(nn.Module):
    def __init__(self, 
        ...
        super(DeblurDiNAT, self).__init__()
...
class DeblurDiNATLocal(Local_Base, DeblurDiNAT):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        DeblurDiNAT.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    ...
    net = DeblurDiNAT(dim=16, chan_adapt=True).cuda()
    ...
    net = DeblurDiNATLocal(dim=16, chan_adapt=True).to(device)
