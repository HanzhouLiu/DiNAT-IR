...
class RestoreNAT(nn.Module):
    def __init__(self, 
        ...
        super(RestoreNAT, self).__init__()
...
class RestoreNATLocal(Local_Base, RestoreNAT):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        RestoreNAT.__init__(self, *args, **kwargs)
