...
datasets = ['results/DeblurDiNATChan-GoPro2RBJ-width16/visualization/', 
            'results/DeblurDiNATChan-GoPro2RBJ-width16/visualization/',
            'results/DeblurDiNATChanGlobl-GoPro2RBJ-width16/visualization/',
            'results/DeblurDiNATChanGlobl-GoPro2RBJ-width16/visualization/']
...
if __name__ == "__main__":
    ...
    dataset_path = sys.argv[1]  # python evaluate.py results/DeblurDiNATChan-GoPro2RBJ-width16/visualization/rbj-padtest/

    # Predicted images directory
    file_path = os.path.join(dataset_path, "output")
    ...
    print('For {:s} dataset PSNR: {:f} SSIM: {:f}\n'.format(dataset_path, avg_psnr, avg_ssim))