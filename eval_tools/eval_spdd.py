...
# SPDD_8bit
parser.add_argument('--clean_dir', default='./datasets/DPDD/test/target', type=str, help='Directory for results')
#parser.add_argument('--clean_dir', default='/mnt/d/Data/Research/low_level/RestoreNAT/results/remote/SPDD/RestoreDiNAT-SPDD-width48-test/visualization/spdd-val', type=str, help='Directory for results')
#parser.add_argument('--restored_dir', default='/mnt/d/Data/Research/low_level/RestoreNAT/results/remote/SPDD/RestoreDiNAT-SPDD-width48-test/visualization/spdd-val', type=str, help='Directory of validation images')
parser.add_argument('--restored_dir', default='/mnt/d/Data/Research/low_level/RestoreNAT/results/remote/SPDD/Single_Image_Defocus_Deblurring', type=str, help='Directory of validation images')

args = parser.parse_args()


#filesC = natsorted(glob(os.path.join(args.clean_dir, 'gt', '*.png')))  # Clean images
filesC = natsorted(glob(os.path.join(args.clean_dir, '*.png')))  # Clean images
