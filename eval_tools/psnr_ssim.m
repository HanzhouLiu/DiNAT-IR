p = genpath('./GoPro-abl/images/DeblurDiNATNoChanLocal-GoPro-width16/visualization/gopro-test/output');% HIDE Deblur Results
gt = genpath('./GoPro-abl/images/Baseline-GoPro-width16/visualization/gopro-test/gt');
length_p = size(p,2);
path = {};
temp = [];
for i = 1:length_p 
